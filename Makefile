...
deploy: mac_deploy mac_deploy_abrav
	curl --netrc-file .netrc --ftp-create-dirs -v -T VS18/Output/EMAV_Setup.exe "ftp://bonkachen.com/downloads/EMAV_Setup.exe"
	curl --netrc-file .netrc --ftp-create-dirs -v -T VS18/Output/ABRAV_Setup.exe "ftp://bonkachen.com/downloads/ABRAV_Setup.exe"

deploy-web:
	curl --netrc-file .netrc --ftp-create-dirs -v -T web/index.html "ftp://bonkachen.com/rc/emav/index.html"
...
mac_deploy: emav/emav
	...
	curl --netrc-file .netrc --ftp-create-dirs -v -T EMAV_Mac.zip "ftp://bonkachen.com/downloads/EMAV_Mac.zip"

mac_deploy_abrav: abrav/abrav
	cd abrav && ./build_mac_app_pkg.sh
	rm -f ABRAV_Mac.zip
	zip -j ABRAV_Mac.zip abrav/ABRAV_App.pkg
	curl --netrc-file .netrc --ftp-create-dirs -v -T ABRAV_Mac.zip "ftp://bonkachen.com/downloads/ABRAV_Mac.zip"
