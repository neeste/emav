...
## Documentation
For comprehensive instructions on how to configure and use EMAV, please see the full **[EMAV User Guide](emav/UserGuide.md)**.
...
make mac_deploy
```
This will build the binaries using GCC and compress them alongside the User Guide into `EMAV_Mac.zip`, before uploading it to the deployment server.
