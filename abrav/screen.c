...
int scrn_c[NUM_SCRN_COLORS] = {
    ...
    LIGHTCYAN,		/* C_MSGF - message panel foreground */
    BLUE,		/* C_MSGB - message panel background */
    YELLOW,		/* C_MSGH - message panel highlight */
    WHITE,		/* C_RFTF - resp. FFT panel foreground */
    ...
    WHITE,		/* C_BTXF - batch text foreground */
    BLUE,		/* C_BTXB - batch text background */
    LIGHTRED,           /* C_CHA1 - channel A buffer 1 */
    WHITE,              /* C_CHA2 - channel A buffer 2 */
    LIGHTBLUE,          /* C_CHB1 - channel B buffer 1 */
    YELLOW,             /* C_CHB2 - channel B buffer 2 */
