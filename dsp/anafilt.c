// anafilt.c - analog-style IIR filter design
...
int bessel(		// Bessel filter design
...
{
    float *p;
    static float wn_min = 0.0013F;  // min. wn for stable 3rd-order Bessel
...
int butter(		// Butterworth filter design
    float *wn,		// cutoff frequency
    float *b, 		// input coeffcients
    float *a, 		// output coeffcients
    int n,		// filter order
