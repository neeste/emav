...
dp_mat(char *fn)
{
    ...
    tok_read(1); mat_wr_f(mfd, "cal1", accbuf, npts);
    tok_read(2); mat_wr_f(mfd, "cal2", accbuf, npts);
...
usage()
{
    ...
    printf("\n");
    printf("where file is a DPOAE calibration file generated by EMAV.\n");
    exit(0);
}
