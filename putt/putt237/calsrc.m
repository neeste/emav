% calths - estimate Thevenin-equivalent source pressure and impedance for CAL file created by PUTT
function calths
...
show_zp(f,zc,pc,1,'cavity')     % plot zc & pc
%
df=f(2)-f(1);
...
show_zp(f,zs,ps,2,'source')     % plot zs & ps
prn_len('initial',lc);
% iterate
...
dcav = 0.8; % cavity diameter (cm)
temp = 25;	% cavity temperature (C)
deltemp = temp - 26.85;
